...
pros::adi::DigitalOut Park1('C', false); // Park Piston left on port C
...
void opcontrol() {
    ...
    while (true) {
        ...
        // =========================== ARCADE INPUT =============================
        // =====================================================================
        int forward = controller.get_analog(pros::E_CONTROLLER_ANALOG_LEFT_Y);   // forward/back
        ...
        // driving straight if pushing forward/back with LOW turning
        bool drivingStraight = (std::abs(forward) > 20 && std::abs(turn) < 25);
        ...
        int leftPower  = forward + turn - correction;
        int rightPower = forward - turn + correction;
